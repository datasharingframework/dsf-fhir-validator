...
class WorkerContext implements IWorkerContext
{
	...
	public WorkerContext(IWorkerContext delegate)
	{
	...
	{
		return delegate.fetchTypeDefinitions(n);
	}

	@Override
	public <T extends Resource> T fetchResource(Class<T> class_, String uri, String version)
	{
		return delegate.fetchResource(class_, uri, version);
	}

	@Override
	public <T extends Resource> T fetchResource(Class<T> class_, String uri, Resource source)
	{
		return delegate.fetchResource(class_, uri, source);
	}

	@Override
	public <T extends Resource> List<T> fetchResourcesByType(Class<T> class_)
	{
		return delegate.fetchResourcesByType(class_);
	}
	...
	{
		return delegate.isPrimitiveType(code);
	}
}
