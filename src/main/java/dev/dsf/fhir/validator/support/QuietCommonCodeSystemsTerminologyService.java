...
public class QuietCommonCodeSystemsTerminologyService extends CommonCodeSystemsTerminologyService
{
	...
	{
		if (UCUM_CODESYSTEM_URL.equals(lookupCodeRequest.getSystem()))
			return lookupUcumCode(lookupCodeRequest.getCode());

		return super.lookupCode(validationSupportContext, lookupCodeRequest);
	}
	...
	{
		logger.warn("call of deprecated lookupCode method");
